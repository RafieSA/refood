...
{{-- filepath: d:\Kuliah\Semester 6\ppl-refood\SI4605-KEL411\resources\views\admin\restaurants\create.blade.php --}}
...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('restaurants.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="discount" id="discount" class="w-full border rounded px-4 py-2" min="0" max="100">
        </div>
